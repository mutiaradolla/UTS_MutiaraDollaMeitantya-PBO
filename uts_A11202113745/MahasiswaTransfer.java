 ...
 */
 ...
 public class MahasiswaTransfer extends MahasiswaBaru {
    ...
    public MahasiswaTransfer(String nim, String nama, int semester, int usia, String krs[], String asalSekolah, String asalUniversitas) {
        super(nim, nama, semester, usia, krs, asalSekolah);//super adalah keyword untuk mengambil constructor dari super class nya
    ...
    public static void main(String[] args) {
        ...
        MahasiswaTransfer mhs = new MahasiswaTransfer("A11.2021.13787", "Ryan Mahardika", 3, 20, krs, "SMAN 1 Bandung" ,"Universitas Padjajaran");
        mhs.infoMahasiswa();
        System.out.println();
