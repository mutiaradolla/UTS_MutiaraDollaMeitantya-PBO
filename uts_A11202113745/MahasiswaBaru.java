 ...
 */
 ...
 public class MahasiswaBaru extends Mahasiswa{
    ...
    public void infoMahasiswa(){
        super.infoMahasiswa();//akan memanggil method infoMahasiswa() dari super class nya
    ...
    public static void main(String[] args) {
        ...
        MahasiswaBaru mhs = new MahasiswaBaru("A11.2021.13767", "Faril Afrizal", 3, 19, krs, "SMAN 1 Bandung");
        mhs.infoMahasiswa();
        System.out.println();
